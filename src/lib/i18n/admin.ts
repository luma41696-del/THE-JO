...
export const ADMIN_STRINGS = {
  ...
  "customers.block": { en: "Block", ar: "حظر" },
  "customers.unblock": { en: "Unblock", ar: "رفع الحظر" },
  "customers.delete": { en: "Delete", ar: "حذف" },
  "customers.blocked": { en: "Blocked", ar: "محظور" },
  "customers.never": { en: "No orders yet", ar: "لا طلبات بعد" },
  "customers.activity": { en: "Activity", ar: "النشاط" },
  "col.access": { en: "Account", ar: "الحساب" },
  ...
  /* ---- import ---- */
  "imp.title": { en: "Import products", ar: "استيراد المنتجات" },
  "imp.subtitle": {
    en: "A spreadsheet from anywhere. Nothing is written until you have seen what it will do.",
    ar: "ملف من أي مصدر. لا يُكتب شيء قبل أن ترى ما سيفعله.",
  },
  "imp.open": { en: "Import", ar: "استيراد" },
  "imp.pickFile": { en: "Choose a file", ar: "اختر ملفًا" },
  "imp.dropHint": {
    en: "CSV or Excel. Commas, semicolons and tabs all work.",
    ar: "CSV أو Excel. الفواصل والفواصل المنقوطة وعلامات الجدولة كلها تعمل.",
  },
  "imp.template": { en: "Download a template", ar: "نزّل قالبًا" },
  "imp.exportAll": { en: "Export the catalogue", ar: "صدّر الكتالوج" },
  "imp.readFailed": { en: "That file could not be read.", ar: "تعذّرت قراءة الملف." },
  "imp.noRows": { en: "There are no rows under the header.", ar: "لا توجد صفوف تحت العناوين." },
  "imp.step.map": { en: "Check the columns", ar: "راجع الأعمدة" },
  "imp.step.review": { en: "What this will do", ar: "ما الذي سيحدث" },
  "imp.column": { en: "Column in your file", ar: "العمود في ملفك" },
  "imp.mapsTo": { en: "Goes to", ar: "يذهب إلى" },
  "imp.sample": { en: "First value", ar: "أول قيمة" },
  "imp.ignore": { en: "Ignore this column", ar: "تجاهل هذا العمود" },
  "imp.unmapped": {
    en: "Columns left as ignored are not imported.",
    ar: "الأعمدة المتروكة كمُتجاهَلة لا تُستورد.",
  },
  "imp.creates": { en: "new products", ar: "منتجات جديدة" },
  "imp.updates": { en: "products changed", ar: "منتجات ستتغير" },
  "imp.unchanged": { en: "already up to date", ar: "محدّثة أصلًا" },
  "imp.duplicates": { en: "repeated in the file", ar: "مكرّرة في الملف" },
  "imp.errors": { en: "rows with a problem", ar: "صفوف بها مشكلة" },
  "imp.line": { en: "Line", ar: "السطر" },
  "imp.willDo": { en: "Will do", ar: "الإجراء" },
  "imp.detail": { en: "Detail", ar: "التفصيل" },
  "imp.act.create": { en: "Add", ar: "إضافة" },
  "imp.act.update": { en: "Change", ar: "تغيير" },
  "imp.act.skip": { en: "No change", ar: "بلا تغيير" },
  "imp.act.duplicate": { en: "Repeated", ar: "مكرّر" },
  "imp.act.error": { en: "Problem", ar: "مشكلة" },
  "imp.matchedBy": { en: "matched by", ar: "طوبق عبر" },
  "imp.apply": { en: "Import", ar: "نفّذ الاستيراد" },
  "imp.applying": { en: "Importing…", ar: "يُستورد…" },
  "imp.onlyErrors": { en: "Show only problems", ar: "أظهر المشاكل فقط" },
  "imp.nothingToDo": {
    en: "Nothing in this file would change anything.",
    ar: "لا شيء في هذا الملف سيغيّر شيئًا.",
  },
  "imp.errorsBlock": {
    en: "Rows with a problem are skipped. Everything else still imports.",
    ar: "الصفوف التي بها مشكلة تُتخطّى. وما عداها يُستورد.",
  },
  "imp.progress": { en: "{done} of {total} rows", ar: "{done} من {total} صفًا" },
  "imp.done": {
    en: "Imported. {created} added, {updated} changed.",
    ar: "تم الاستيراد. أُضيف {created} وتغيّر {updated}.",
  },
  "imp.failedSlice": {
    en: "The connection dropped partway. Nothing is lost — press Resume to carry on from where it stopped.",
    ar: "انقطع الاتصال في المنتصف. لم يُفقد شيء — اضغط «متابعة» لإكمال ما توقف.",
  },
  "imp.resume": { en: "Resume", ar: "متابعة" },
  "imp.undo": { en: "Undo this import", ar: "تراجع عن هذا الاستيراد" },
  "imp.undoing": { en: "Undoing…", ar: "يُتراجع…" },
  "imp.undone": {
    en: "Put back. {restored} restored, {deleted} removed.",
    ar: "أُعيد كما كان. استُعيد {restored} وحُذف {deleted}.",
  },
  "imp.undoKept": {
    en: "{n} were left alone because somebody edited them after the import.",
    ar: "تُرك {n} دون تغيير لأن أحدهم عدّلها بعد الاستيراد.",
  },
  "imp.undoFailed": { en: "That import could not be undone.", ar: "تعذّر التراجع عن الاستيراد." },
  "imp.recent": { en: "Recent imports", ar: "عمليات استيراد سابقة" },
  "imp.rowsWord": { en: "rows", ar: "صفًا" },
  "imp.startOver": { en: "Start over", ar: "ابدأ من جديد" },
  ...
  /* ---- email campaigns ---- */
  "nav.campaigns": { en: "Email campaigns", ar: "حملات البريد" },
  "cmp.title": { en: "Email campaigns", ar: "حملات البريد" },
  "cmp.subtitle": { en: "Write an announcement and send it to your customers.", ar: "اكتب إعلاناً وأرسله إلى عملائك." },
  "cmp.compose": { en: "The message", ar: "الرسالة" },
  "cmp.language": { en: "Language", ar: "اللغة" },
  "cmp.languageHint": { en: "Customers who chose the other language still get theirs. This is the default for everyone else.", ar: "من اختار اللغة الأخرى تصله بلغته. هذه اللغة الافتراضية لمن عداهم." },
  "cmp.subject": { en: "Subject", ar: "عنوان الرسالة" },
  "cmp.preheader": { en: "Preview line", ar: "سطر المعاينة" },
  "cmp.preheaderHint": { en: "The grey line beside the subject in the inbox. Left empty, the mail client picks one.", ar: "السطر الرمادي بجانب العنوان في البريد الوارد. إن تُرك فارغاً يختار البريد سطراً بنفسه." },
  "cmp.heading": { en: "Heading", ar: "العنوان الرئيسي" },
  "cmp.body": { en: "Body", ar: "النص" },
  "cmp.bodyHint": { en: "A blank line starts a new paragraph.", ar: "سطر فارغ يبدأ فقرة جديدة." },
  "cmp.hero": { en: "Banner image URL", ar: "رابط صورة الغلاف" },
  "cmp.heroHint": { en: "Must be https. Most inboxes block images until the reader allows them, so never put words only in the picture.", ar: "يجب أن يكون https. أغلب صناديق البريد تحجب الصور حتى يسمح القارئ، فلا تضع كلاماً داخل الصورة وحدها." },
  "cmp.ctaLabel": { en: "Button text", ar: "نص الزر" },
  "cmp.ctaUrl": { en: "Button link", ar: "رابط الزر" },
  "cmp.products": { en: "Featured products", ar: "منتجات مختارة" },
  "cmp.productsHint": { en: "Up to four, shown as a grid.", ar: "حتى أربعة، تُعرض على شكل شبكة." },
  "cmp.searchProducts": { en: "Search products", ar: "ابحث في المنتجات" },
  "cmp.audience": { en: "Who receives it", ar: "من يستلمها" },
  "cmp.sendable": { en: "{n} will receive it", ar: "ستصل {n}" },
  "cmp.suppressedNote": { en: "{n} unsubscribed and are excluded.", ar: "{n} ألغوا الاشتراك ومستبعدون." },
  "cmp.preview": { en: "Preview", ar: "معاينة" },
  "cmp.previewNote": { en: "This is the real email, built by the same code that sends it. The unsubscribe link here is a sample.", ar: "هذه هي الرسالة الحقيقية، مبنية بنفس الكود الذي يرسلها. رابط إلغاء الاشتراك هنا للعرض فقط." },
  "cmp.test": { en: "Send a test", ar: "أرسل نسخة تجريبية" },
  "cmp.testHint": { en: "Goes to this address only. No customer data is read.", ar: "تُرسل إلى هذا العنوان فقط. لا تُقرأ أي بيانات عملاء." },
  "cmp.testTo": { en: "Test address", ar: "عنوان التجربة" },
  "cmp.testSent": { en: "Test sent to {n}.", ar: "أُرسلت النسخة التجريبية إلى {n}." },
  "cmp.send": { en: "Send to {n}", ar: "أرسل إلى {n}" },
  "cmp.sendHeading": { en: "Send this campaign", ar: "إرسال هذه الحملة" },
  "cmp.sendConfirm": { en: "Type the number of recipients to confirm", ar: "اكتب عدد المستلمين للتأكيد" },
  "cmp.sendGo": { en: "Send it", ar: "أرسلها" },
  "cmp.sending": { en: "Sending...", ar: "جارٍ الإرسال…" },
  "cmp.progress": { en: "{done} of {total} sent...", ar: "أُرسلت {done} من {total}…" },
  "cmp.sentAll": { en: "{n} messages sent.", ar: "أُرسلت {n} رسالة." },
  "cmp.sentPartial": { en: "{ok} sent, {bad} failed.", ar: "أُرسلت {ok}، وفشلت {bad}." },
  "cmp.irreversible": { en: "Email cannot be recalled. Read the preview once more before you send.", ar: "لا يمكن استرجاع البريد بعد إرساله. راجع المعاينة مرة أخرى قبل الإرسال." },
  "cmp.notReady": { en: "Sending is not set up yet. Missing: {n}", ar: "الإرسال غير مهيأ بعد. الناقص: {n}" },
  "cmp.notReadyHint": { en: "Previews and drafts work now. Nothing can leave until these are set on the server.", ar: "المعاينة والمسودات تعمل الآن. لا شيء يمكن أن يُرسل حتى تُضبط هذه على الخادم." },
  ...
  /* ---- points ---- */
  "pts.title": { en: "Points", ar: "النقاط" },
  "pts.hint": { en: "What the shop pays for points, and what a point is worth when spent.", ar: "ما يدفعه المتجر مقابل النقاط، وكم تساوي النقطة عند الإنفاق." },
  "pts.value": { en: "What one point is worth", ar: "كم تساوي النقطة الواحدة" },
  "pts.valueHint": { en: "In dinars. This multiplies every balance already issued, not only new ones.", ar: "بالدينار. يضرب هذا كل رصيد صادر سابقاً، لا الجديد فقط." },
  "pts.example": { en: "So {a} points = {b}", ar: "أي {a} نقطة = {b}" },
  "pts.reviewTitle": { en: "For a review", ar: "مقابل تقييم" },
  "pts.reviewPoints": { en: "Points per published review", ar: "نقاط لكل تقييم منشور" },
  "pts.reviewMinLength": { en: "Shortest review that earns (characters)", ar: "أقصر تقييم يُكافأ (حروف)" },
  "pts.reviewPhoto": { en: "Extra for a review with a photo", ar: "إضافي للتقييم مع صورة" },
  "pts.reviewMinRating": { en: "Lowest star rating that earns", ar: "أقل تقييم نجوم يُكافأ" },
  "pts.reviewRatingWarn": { en: "Leave this at 1. Paying only for five stars is review manipulation — it is illegal in much of the world, and it makes every review on your site worth less to the customers reading them. Paying for any substantive review gets you the same volume honestly.", ar: "اتركه على 1. الدفع مقابل خمس نجوم فقط تلاعب بالتقييمات — مخالف للقانون في كثير من الدول، ويجعل كل تقييم في موقعك أقل قيمة لدى من يقرؤه. مكافأة أي تقييم ذي مضمون تعطيك نفس العدد بطريقة نزيهة." },
  "pts.reviewOnlyPublished": { en: "Only a published review earns. A review waiting on moderation pays nothing until you approve it.", ar: "التقييم المنشور فقط يُكافأ. التقييم المنتظر للمراجعة لا يدفع شيئاً حتى توافق عليه." },
  "pts.referralTitle": { en: "For inviting a friend", ar: "مقابل دعوة صديق" },
  "pts.referralInviter": { en: "To the person who invited", ar: "لمن أرسل الدعوة" },
  "pts.referralInvitee": { en: "To the person who joined", ar: "لمن انضم" },
  "pts.referralRequiresOrder": { en: "Only pay once the invited person has ordered", ar: "ادفع فقط بعد أن يطلب المدعوّ" },
  "pts.referralWarn": { en: "Keep this on. Paying on sign-up costs nothing to farm — one person, many accounts. Paying on a real order costs them the price of the order.", ar: "أبقِه مفعّلاً. الدفع عند التسجيل لا يكلّف شيئاً لمن يريد استغلاله — شخص واحد بحسابات كثيرة. الدفع عند طلب حقيقي يكلّفه ثمن الطلب." },
  "pts.wheelTitle": { en: "Lucky wheel", ar: "عجلة الحظ" },
  "pts.wheelHint": { en: "Points can be a prize on the wheel. Set the amount on each prize in the gift game.", ar: "يمكن أن تكون النقاط جائزة على العجلة. اضبط العدد على كل جائزة في لعبة الهدايا." },
  "pts.enabled": { en: "On", ar: "مفعّل" },
  "pts.save": { en: "Save", ar: "احفظ" },
  "pts.saving": { en: "Saving...", ar: "جارٍ الحفظ…" },
  "pts.saved": { en: "Saved.", ar: "تم الحفظ." },
  "pts.adminOnly": { en: "Only an administrator can change what points are worth.", ar: "الأدمن فقط يمكنه تغيير قيمة النقاط." },
  /* ---- opening and closing the shop ---- */
  "shop.title": { en: "Shop open or closed", ar: "المتجر مفتوح أو مغلق" },
  "shop.hint": { en: "Closes the storefront for visitors. This admin always stays open.", ar: "يغلق واجهة المتجر أمام الزوار. لوحة الإدارة تبقى مفتوحة دائماً." },
  "shop.state": { en: "State", ar: "الحالة" },
  "shop.reason": { en: "Reason", ar: "السبب" },
  "shop.message": { en: "Your own wording", ar: "نصّك الخاص" },
  "shop.messageHint": { en: "Replaces the standard sentence. Leave empty to use it.", ar: "يحل محل الجملة الافتراضية. اتركه فارغاً لاستخدامها." },
  "shop.messageEn": { en: "In English", ar: "بالإنجليزية" },
  "shop.messageAr": { en: "In Arabic", ar: "بالعربية" },
  "shop.reopensAt": { en: "Reopen automatically at", ar: "يُفتح تلقائياً في" },
  "shop.reopensHint": { en: "The shop lets itself back in at this time, with nobody touching anything. Leave empty to reopen by hand.", ar: "يفتح المتجر نفسه في هذا الوقت دون أن يلمس أحد شيئاً. اتركه فارغاً لتفتحه يدوياً." },
  "shop.reopensClear": { en: "Clear", ar: "امسح" },
  "shop.save": { en: "Save", ar: "احفظ" },
  "shop.saving": { en: "Saving...", ar: "جارٍ الحفظ…" },
  "shop.saved": { en: "Saved.", ar: "تم الحفظ." },
  "shop.reopen": { en: "Open the shop", ar: "افتح المتجر" },
  "shop.preview": { en: "See the notice", ar: "شاهد الإشعار" },
  "shop.bannerClosed": { en: "The shop is closed to visitors.", ar: "المتجر مغلق أمام الزوار." },
  "shop.bannerBrowse": { en: "The shop is open but not taking orders.", ar: "المتجر مفتوح لكنه لا يستقبل طلبات." },
  "shop.bannerBy": { en: "Set by {n}", ar: "غيّرها {n}" },
  "shop.bannerUntil": { en: "until {n}", ar: "حتى {n}" },
  "shop.adminOnly": { en: "Only an administrator can open or close the shop.", ar: "الأدمن فقط يمكنه فتح المتجر أو إغلاقه." },
  "shop.confirmClose": { en: "Close the shop to visitors?", ar: "إغلاق المتجر أمام الزوار؟" },
  "shop.confirmCloseBody": { en: "Every visitor sees the notice instead of the shop, and no order can be placed. You can reopen from here at any time.", ar: "سيرى كل زائر الإشعار بدل المتجر، ولن يمكن تقديم أي طلب. يمكنك إعادة الفتح من هنا في أي وقت." },
  "shop.confirmGo": { en: "Close it", ar: "أغلقه" },
  "shop.cancel": { en: "Cancel", ar: "إلغاء" },
} satisfies AdminDict;
