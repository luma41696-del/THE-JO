...
const COLORS: Record<string, ProductColor> = {
  ink: { id: "ink", name: { en: "Ink", ar: "حبري" }, hex: "#0B0B0F" },
  bone: { id: "bone", name: { en: "Bone", ar: "عاجي" }, hex: "#EFE9DE" },
  violet: { id: "violet", name: { en: "Signature Violet", ar: "بنفسجي التوقيع" }, hex: "#703BEC" },
...
export const demoBanners: Banner[] = [
  ...
  },
  {
    ...
    media: { url: "/demo/campaign-violet.svg", alt: "Private sale", width: 900, height: 640 },
    endsAt: NOW + 4 * DAY,
    priority: 90,
    span: 2,
    active: true,
  },
  {
    ...
    title: { en: "The Crescent, in violet", ar: "الهلال، بالبنفسجي" },
